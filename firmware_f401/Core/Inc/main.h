...
#include "user_code/bldc_driver.h"
...
#define V_H_Pin GPIO_PIN_0
#define V_H_GPIO_Port GPIOA
#define V_L_Pin GPIO_PIN_1
...
#define W_H_Pin GPIO_PIN_6
#define W_H_GPIO_Port GPIOB
#define W_L_Pin GPIO_PIN_7
